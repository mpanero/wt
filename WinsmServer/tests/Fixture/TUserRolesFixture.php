 ...
 * TUserRolesFixture
 */
class TUserRolesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        'ID_ROL' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['ID_ROL'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
