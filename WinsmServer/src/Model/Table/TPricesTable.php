 ...
 * @method \App\Model\Entity\TPrice|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\TPrice saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
