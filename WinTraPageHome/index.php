...
<table width="750" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #6A0000; border-left: 1px solid #990000; border-right: 1px solid #990000; ">
	...
	<tr>
    	...
    	<tr>
        	...
        	<tr>
          	<td align="left" valign="top" class="Items"><div align="justify">Para acceder a su panel de control haga <a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>:2082/" target="_blank">click aqu&iacute;</a> y utilice los datos de acceso que recibi&oacute; de su proveedor.<br />
